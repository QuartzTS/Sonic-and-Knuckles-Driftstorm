...
var characterLabels = ["Sonic and Knuckles", "Sonic and Tails", "Sonic", "Knuckles", "Tails and Amy", "Tails", "Amy"]
# character id lines up with characterLabels
enum CHARACTER_ID { SONIC_AND_KNUCKLES, SONIC_AND_TAILS, SONIC, KNUCKLES, TAILS_AND_AMY, TAILS, AMY }
var characterID = CHARACTER_ID.SONIC_AND_KNUCKLES
...
func _ready():
	...
	Global.discord_rpc_customize("Selecting characters...", "Who should I choose?")
...
func _input(event):
	...
	if !selected:
		...
		if event.is_action_pressed("gm_pause"):
			...
			# set the character
			match(characterID):
				CHARACTER_ID.SONIC_AND_KNUCKLES:
				...
				CHARACTER_ID.TAILS_AND_AMY:
					Global.PlayerChar1 = Global.CHARACTERS.TAILS
					Global.PlayerChar2 = Global.CHARACTERS.AMY
				CHARACTER_ID.TAILS:
					Global.PlayerChar1 = Global.CHARACTERS.TAILS
				CHARACTER_ID.KNUCKLES:
					Global.PlayerChar1 = Global.CHARACTERS.KNUCKLES
